...
export function addIdentity(p,id,kit,flags){
 ...
 function flag(x,z,country){
  ...
  const canvas=document.createElement('canvas');canvas.width=480;canvas.height=300;const c=canvas.getContext('2d');c.scale(2,2);
